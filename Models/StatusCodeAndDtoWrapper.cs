...
namespace ApiCoreAdoNetCrudPagination.Models

{
    public class StatusCodeAndDtoWrapper : ObjectResult
    {
        ...
        public static IActionResult BuildErrorResponse(string message, int statusCode = 500)
        {
            return new StatusCodeAndDtoWrapper(new ErrorDtoResponse(message), statusCode);
        }
        ...
        public static IActionResult BuildNotFound(string message)
        {
            return BuildErrorResponse(message, 404);
        }
    }
}