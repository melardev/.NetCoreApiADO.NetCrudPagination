...
# Introduction
This is a mini application implementing REST CRUD operations with Pagination using ASP.Net Core with ADO.NET(Raw SQL Queries and Stored
Procedures).

# Getting Started
- This project uses MSSQL Server, run the setup.sql to create the database, table and stored procedures against your MSSQL Server.
Then you would be ready to go with the API.
